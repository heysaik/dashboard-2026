...
- **Weather:** click the current conditions to slide the six-day forecast closed or open. Enter and Space also toggle it. City, units and “Show forecast lows” live on the back. Forecasts refresh when Dashboard returns after the refresh interval.
